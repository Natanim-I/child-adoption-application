...
import { loginEmployee } from "../../auth/actions/userActions";
import { useNavigate, useParams } from "react-router-dom";

const EmployeeSignIn = ({loginEmployee}) => {
    ...
    return (
        <StyledContainer>
            <StyledFormArea>
                ...
                <ExtraText>
                    <TextLink to="/signin/organizationUsers/admin">Administrative User Access</TextLink>
                </ExtraText>
                <Formik 
                initialValues={{
                    email: userEmail,
                ...
                onSubmit={(values, {setSubmitting, setFieldError}) => {
                    loginEmployee(values, navigate, setFieldError, setSubmitting);
                }}>
                    {({isSubmitting}) => (
                        <Form>
                ...
                <ExtraText>
                    Forgotten password? <TextLink to="/forgotEmppassword">Reset it</TextLink>
                </ExtraText>
            </StyledFormArea>
        </StyledContainer>
    );
...
export default connect(null, {loginEmployee})(EmployeeSignIn);