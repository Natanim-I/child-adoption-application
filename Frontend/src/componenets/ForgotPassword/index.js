...
import { forgottenAdminPassword } from "./../../auth/actions/userActions";
import { useNavigate, useParams } from "react-router-dom";

const ForgotPassword = ({forgottenAdminPassword}) => {
        ...
        <StyledContainer>
            <StyledFormArea>
                ...
                onSubmit={(values, {setSubmitting, setFieldError}) => {
                    forgottenAdminPassword(values, navigate, setFieldError, setSubmitting);
                }}>
                    {({isSubmitting}) => (
                        <Form>
...
export default connect(null, {forgottenAdminPassword})(ForgotPassword);