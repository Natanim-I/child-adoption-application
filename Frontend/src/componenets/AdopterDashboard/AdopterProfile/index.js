...
UpdateItem, UpdateRight, MyPublish, ItemUpload, ItemUploadImg, ItemUpdateButton} from "./AdopterProfileElements"
import { connect } from 'react-redux'

const AdopterView = ({user}) => {
  return (
    <ItemContainer>
      <ItemTitleContainer>
        <h1>Profile</h1>
...
export default connect(mapStateToProps)(AdopterView); 