...
import { resetAdminPassword } from "../../auth/actions/userActions";
import { useNavigate, useParams } from "react-router-dom";

const AdminPassReset = ({resetAdminPassword}) => {
        ...
        <StyledContainer>
            <StyledFormArea>
                ...
                onSubmit={(values, {setSubmitting, setFieldError}) => {
                    resetAdminPassword(values, navigate, setFieldError, setSubmitting);
                }}>
                    {({isSubmitting}) => (
                        <Form>
...
export default connect(null, {resetAdminPassword})(AdminPassReset);